---
title: 雷神G150T2015款Hackintosh安装
toc: true
comment: true
date: 2018-12-14 18:15:30
tags:  
  - 黑苹果
  - 雷神
  - MACOS
...
**雷神G150TH2015年款黑苹果安装记录**
>镜像下载：[黑果小兵](https://blog.daliansky.net/macOS-Mojave-10.14.1-18B75-official-version-with-Clover-4726-original-image.html)
>参考文章：[国光](https://www.sqlsec.com/2018/08/clover.html)
...
SSD：team128G Kingston120G Kingston256G
...
# EFI文件备份
链接: https://pan.baidu.com/s/13Vkr7CmHwIEkOPTfC5dAdg 提取码: 1qyi 
...
<dict>
	...
	<dict>
		...
		<key>Arguments</key>
		<string>-v dart=0 nv_disable=1 kext-dev-mode=1 debug=0x100 -alcoff</string>
...
```  
PS：驱动HDMI修改ig-platform-id为`0x0d260007`既可

# 目前存在问题
1. wifi无法使用，淘宝黑苹果网卡解决
2. Airdrop也无法使用（of course）
3. 偶尔会死机
4. 电池图标永久显示充电中，待解决
5. 小太阳暂时没有测试，待解决
